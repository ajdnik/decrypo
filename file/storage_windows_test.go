...
var storageTests = []struct {
	...
	}, []byte{1, 2, 3}, decryptor.Extension("ext"), "C:\\path\\course\\1-module\\1-clip.ext", nil},
	...
	}, []byte{1, 2, 3}, decryptor.Extension("ext"), "C:\\path\\course-with-long-name\\1-module-with-long-name\\1-clip-with-long-name.ext", nil},
}
